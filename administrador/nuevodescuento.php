         ...
         <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mx-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item px-4">
                            <a class="nav-link active" aria-current="page" href="descuentos.php" style="text-transform: uppercase;">Descuentos</a>
                        </li>
                        <li class="nav-item px-4">
                        ...
                        <div class="about-text">
                            <form action="../fun/agregardescuento.php" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="control-group">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Ingresa el nombre del descuento" required="required" data-validation-required-message="Por favor ingresa tu Nombre" />
