...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Ana Leal - Ropa para Boda</title>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mx-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item px-4">
                            <a class="nav-link active" aria-current="page" href="ropaboda.php" style="text-transform: uppercase;">Ropa&nbsp;de&nbsp;boda</a>
                        </li>
                        <li class="nav-item px-4">
...
<br>
        ...
        <?php
            ...
            $resultado = $conexion ->query("select * from prendas WHERE iddepartamento = '1' order by idprenda ASC ")or die($conexion -> error);
